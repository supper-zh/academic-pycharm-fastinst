...
def add_fastinst_config(cfg):
    ...
    # TODO: 新增动态权重 NO_OBJECT_WEIGHT_START END
    cfg.MODEL.FASTINST.NO_OBJECT_WEIGHT_START = 0.05
    cfg.MODEL.FASTINST.NO_OBJECT_WEIGHT_END = 0.15
    ...
    #
    # TODO: 新增 REWEIGHT 配置 定义 ALPHA_REWEIGHT的动态权重
    cfg.REWEIGHT = CN()
    cfg.REWEIGHT.NAME = "reweight_loss_labels"  # 重加权损失函数名称
    cfg.REWEIGHT.LOSS_TYPE = "CE"  # 重加权损失函数类型
    cfg.REWEIGHT.ALPHA_REWEIGHT = 8.0  # 重加权损失函数权重
    cfg.REWEIGHT.ALPHA_START = 10.0  # 重加权损失函数权重
    cfg.REWEIGHT.ALPHA_END = 2.0  # 重加权损失函数权重
