...
class FastInst(nn.Module):
    ...
    def from_config(cls, cfg):
        ...
        criterion = SetCriterion(
            ...
            # TODO: 增加了alpha_weight参数，用于调整cfg.REWEIGHT.ALPHA_START的权重
            # alpha_weight=cfg.REWEIGHT.ALPHA_REWEIGHT,
            alpha_weight=cfg.REWEIGHT.ALPHA_START,
        )
    ...
    def instance_inference(self, mask_cls, mask_pred):
        ...
        # TODO: 这里改了，因为使用之前的代码，这里会报错 topk_indices = topk_indices // self.sem_seg_head.num_classes
        # topk_indices = topk_indices // self.sem_seg_head.num_classes  # UserWarning: __floordiv__is deprecated, and its behavior will change in a future version of pytorch.
